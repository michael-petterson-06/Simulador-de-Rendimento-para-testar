...
export const ModalRemoverHistorico = ({ onConfirmar, onCancelar, titulo, paragrafo }: ModalRemoverHistoricoProps) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-xl max-w-sm w-full space-y-4 text-center animate-fade-in">
        ...
        <h2 className="text-lg font-semibold text-rose-600">{titulo}</h2>
